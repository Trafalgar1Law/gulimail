...
public class PmsOssController {
    String accessId = "LTAIaxvzc9Fm5oFQ";      // 请填写您的AccessKeyId。
    String accessKey = "JTairR47ZV6YGBCzVAX5SYt8ke0une"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "guli-190222-sh";                    // 请填写您的 bucketname 。
